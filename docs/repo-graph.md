...
- `web/src/app/course/lesson-viewer.ts` (122 lines, angular-app)
  - symbols: LessonViewerComponent, track, module, moduleIndex, previousModule, nextModule, lessonHtml, lessonLoading, isComplete
