...
Generated: 2026-07-18 05:52 UTC
Root: `Academia_Floci`
Indexed files: 768
Import edges: 31
...
- `web/src/app/app.spec.ts` (150 lines) - imports: @angular/core/testing, @angular/router, @angular/router/testing, ./app, ./app.routes, ./catalog/course-catalog, ./course-data
