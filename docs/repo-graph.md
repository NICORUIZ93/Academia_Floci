...
Generated: 2026-07-21 07:51 UTC
Root: `Academia_Floci`
Indexed files: 782
Import edges: 33
...
- `docs/editorial-backlog.md` (57 lines) - headings: # Deuda editorial verificable, ## Estado global, ## Prioridad por track, ## Temas sin código editorial
...
- `.gitignore` (25 lines)
- `docs/code-visual-quality.json` (5159 lines)
