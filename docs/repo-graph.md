...
Generated: 2026-07-18 04:02 UTC
Root: `Academia_Floci`
Indexed files: 778
Import edges: 30
...
- `scripts/validate.sh` (482 lines, automation-script)
...
- `web/src/app/app.ts` (11 lines, angular-app)
  - symbols: App
- `web/src/app/course-data.ts` (1069 lines, angular-app)
...
- `web/src/app/course/lesson-viewer.ts` (637 lines, angular-app)
  - symbols: LessonViewerComponent, TocItem, track, module, moduleIndex, isCloudIntroduction, previousModule, nextModule, lessonHtml, lessonLoading
...
- `web/src/app/course-data.ts` (1069 lines) - symbols: ServiceGroup, CloudComparison, AltCloudGroup; imports: ./course-module.model, ./tracks/devops.track, ./tracks/javascript.track, ./tracks/node.track, ./tracks/angular.track, ./tracks/react.track, ./tracks/java.track, ./tracks/spring-boot.track
...
- `scripts/audit_topic_learning_quality.py` (113 lines) - symbols: topic_blocks, evaluate, classify, build, render_markdown, main; imports: __future__, argparse, json, re, collections, pathlib
