...
Generated: 2026-07-20 05:25 UTC
Root: `Academia_Floci`
Indexed files: 776
Import edges: 33
...
- `web/src/app/course/lesson-viewer.ts` (627 lines, angular-app)
...
- `.gitignore` (25 lines)
- `docs/code-visual-quality.json` (5523 lines)
...
- `docs/student-journey-audit.json` (4332 lines)
