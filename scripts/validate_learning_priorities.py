...
for requirement in ("completeExercise", "passQuiz", "totalXp", "badge"):
...
print(f"Prioridades educativas OK: {modules} módulos, {topics} temas, 3 ejercicios y 5 preguntas por módulo, 12 proyectos y gamificación persistente.")
