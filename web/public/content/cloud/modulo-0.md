...
Este recorrido parte de una carpeta vacía. Al finalizar tendrás **Un laboratorio de instalación y verificación de herramientas (sin código de aplicación todavía) y cuatro ejercicios cortos: dos de reflexión sobre qué esperas de un emulador de nube local frente a una cuenta real, uno de repaso del entorno instalado, y uno que verifica que entendiste el recorrido completo de un comando hasta convertirse en una petición HTTP. No hay proyecto de código en este módulo: es la base sobre la que se apoyan los 31 módulos siguientes.** No avances ejecutando comandos que no comprendes: primero identifica la entrada, la transformación y la evidencia que comprobará el resultado.
...
|---|---|---|
| 1. Fundamentos absolutos — qué es una terminal, un comando y un sistema operativo | `infra/module-0/topic-1-fundamentos-absolutos-que-es-una-terminal-un-comando-y.tf` | prueba + salida observable |
| 2. Fundamentos de redes — direcciones IP, puertos, HTTP y APIs | `infra/module-0/topic-2-fundamentos-de-redes-direcciones-ip-puertos-http-y-api.tf` | prueba + salida observable |
| 3. Qué vas a aprender y cómo está estructurado el curso | `infra/module-0/topic-3-que-vas-a-aprender-y-como-esta-estructurado-el-curso.tf` | prueba + salida observable |
| 4. Qué es Floci — definición, propósito y comparativa con LocalStack | `infra/module-0/topic-4-que-es-floci-definicion-proposito-y-comparativa-con-lo.tf` | prueba + salida observable |
| 5. Servicios que emula Floci — AWS, Azure y GCP | `infra/module-0/topic-5-servicios-que-emula-floci-aws-azure-y-gcp.tf` | prueba + salida observable |
| 6. Ventajas y limitaciones de practicar con un emulador local | `infra/module-0/topic-6-ventajas-y-limitaciones-de-practicar-con-un-emulador-l.tf` | prueba + salida observable |
| 7. Metodología de estudio — teoría, laboratorio y evaluación en cada módulo | `infra/module-0/topic-7-metodologia-de-estudio-teoria-laboratorio-y-evaluacion.tf` | prueba + salida observable |
...
Cambia un endpoint, permiso o identificador por un valor inválido; inspecciona la respuesta del emulador antes de corregir. Guarda en `evidence/module-0/` el comando, la salida relevante, tu hipótesis y la corrección. Revierte únicamente el cambio deliberado; no borres todo el proyecto para ocultar la causa.

### 6. Conecta el capítulo con RutaFlow

Aplica el aprendizaje de **Introducción y preparación** a un incremento vertical de RutaFlow. Define qué componente produce el dato, qué contrato lo transporta, quién lo consume y cómo observarás un fallo. La entrega final incluye archivo o decisión, prueba, salida, error corregido y una limitación que todavía validarías en producción.
