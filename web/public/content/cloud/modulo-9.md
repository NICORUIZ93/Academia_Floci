...
Este recorrido parte de una carpeta vacía. Al finalizar tendrás **El proyecto final completo (descrito abajo con requisitos funcionales, técnicos, entregables y rúbrica), más los apéndices de referencia rápida, glosario y bibliografía que cierran el curso.** No avances ejecutando comandos que no comprendes: primero identifica la entrada, la transformación y la evidencia que comprobará el resultado.
...
|---|---|---|
| 1. Arquitectura de la aplicación — frontend, backend y base de datos | `infra/module-9/topic-1-arquitectura-de-la-aplicacion-frontend-backend-y-base-.tf` | prueba + salida observable |
| 2. CRUD de tareas sobre DynamoDB expuesto por Lambda | `infra/module-9/topic-2-crud-de-tareas-sobre-dynamodb-expuesto-por-lambda.tf` | prueba + salida observable |
| 3. Archivos adjuntos en S3 y procesamiento en segundo plano con SQS | `infra/module-9/topic-3-archivos-adjuntos-en-s3-y-procesamiento-en-segundo-pla.tf` | prueba + salida observable |
| 4. API Gateway e IAM de mínimo privilegio para el proyecto | `infra/module-9/topic-4-api-gateway-e-iam-de-minimo-privilegio-para-el-proyect.tf` | prueba + salida observable |
| 5. Documentación de la API y guía de despliegue | `infra/module-9/topic-5-documentacion-de-la-api-y-guia-de-despliegue.tf` | prueba + salida observable |
...
Cambia un endpoint, permiso o identificador por un valor inválido; inspecciona la respuesta del emulador antes de corregir. Guarda en `evidence/module-9/` el comando, la salida relevante, tu hipótesis y la corrección. Revierte únicamente el cambio deliberado; no borres todo el proyecto para ocultar la causa.

### 6. Conecta el capítulo con RutaFlow

Aplica el aprendizaje de **Proyecto final — Sistema de Gestión de Tareas** a un incremento vertical de RutaFlow. Define qué componente produce el dato, qué contrato lo transporta, quién lo consume y cómo observarás un fallo. La entrega final incluye archivo o decisión, prueba, salida, error corregido y una limitación que todavía validarías en producción.
