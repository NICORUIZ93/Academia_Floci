...
|---|---|---|
| 1. Reactive Forms — FormGroup y FormControl | `src/app/features/module-5/topic-1-reactive-forms-formgroup-y-formcontrol.ts` | prueba + salida observable |
| 2. Validadores asíncronos | `src/app/features/module-5/topic-2-validadores-asincronos.ts` | prueba + salida observable |
| 3. FormArray para campos dinámicos | `src/app/features/module-5/topic-3-formarray-para-campos-dinamicos.ts` | prueba + salida observable |
| 4. Template-driven forms — cuándo siguen siendo válidos | `src/app/features/module-5/topic-4-template-driven-forms-cuando-siguen-siendo-validos.ts` | prueba + salida observable |
...
**Resultado esperado:** el comando reconoce el proyecto y termina sin errores antes de introducir el cambio del capítulo. Después del incremento, la evidencia debe demostrar: **Un formulario multi-paso con validación reactiva y mensajes de error claros, más tres ejercicios de evaluación.**

Si falla la línea base, no continúes. Localiza el primer mensaje que indique archivo, línea o dependencia; formula una causa y compruébala con un cambio pequeño.

### 5. Provoca un fallo y recupérate

Simula un estado vacío o un error HTTP y comprueba que la interfaz muestre recuperación y no una pantalla ambigua. Guarda en `evidence/module-5/` el comando, la salida relevante, tu hipótesis y la corrección. Revierte únicamente el cambio deliberado; no borres todo el proyecto para ocultar la causa.

### 6. Conecta el capítulo con RutaFlow

Aplica el aprendizaje de **Formularios reactivos y template-driven** a un incremento vertical de RutaFlow. Define qué componente produce el dato, qué contrato lo transporta, quién lo consume y cómo observarás un fallo. La entrega final incluye archivo o decisión, prueba, salida, error corregido y una limitación que todavía validarías en producción.
