...
Nombre: ____________________  Fecha de inicio: ____________________

## Reglas

- No marcar una lección solo por leerla.
- Conservar comandos, código, salida y errores como evidencia.
- Explicar cada recurso sin consultar la guía.
- Repetir desde cero los hitos 1, 4, 8 y 12.
- Consultar ejemplos únicamente después de un intento propio documentado.

## Registro de sesión

Duplica este bloque en cada sesión:
...
| Hito | Comando o prueba | Resultado | Archivo propio | Fecha |
|---|---|---|---|---|
| Arranque | | | | |
| Primer objeto S3 | | | | |
| Primera cola | | | | |
...
Califica de 0 a 3: `0` no lo conozco, `1` lo reconozco, `2` lo hago con
documentación, `3` lo hago y lo explico.

| Competencia | Inicio | Final |
|---|---:|---:|
