...
Este recorrido parte de una carpeta vacía. Al finalizar tendrás **Capa de dominio compartida (modelos + casos de uso) sin código específico de plataforma, más tres ejercicios de evaluación.** No avances ejecutando comandos que no comprendes: primero identifica la entrada, la transformación y la evidencia que comprobará el resultado.
...
|---|---|---|
| 1. Modelos de dominio y casos de uso | `shared/src/commonMain/kotlin/module-4/topic-1-modelos-de-dominio-y-casos-de-uso.kt` | prueba + salida observable |
| 2. Repositorios con interfaz común | `shared/src/commonMain/kotlin/module-4/topic-2-repositorios-con-interfaz-comun.kt` | prueba + salida observable |
| 3. Inyección de dependencias multiplataforma con Koin | `shared/src/commonMain/kotlin/module-4/topic-3-inyeccion-de-dependencias-multiplataforma-con-koin.kt` | prueba + salida observable |
...
**Resultado esperado:** el comando reconoce el proyecto y termina sin errores antes de introducir el cambio del capítulo. Después del incremento, la evidencia debe demostrar: **Capa de dominio compartida (modelos + casos de uso) sin código específico de plataforma, más tres ejercicios de evaluación.**

Si falla la línea base, no continúes. Localiza el primer mensaje que indique archivo, línea o dependencia; formula una causa y compruébala con un cambio pequeño.

### 5. Provoca un fallo y recupérate

Introduce un dato nulo o caso específico de plataforma; commonTest debe hacerlo visible. Guarda en `evidence/module-4/` el comando, la salida relevante, tu hipótesis y la corrección. Revierte únicamente el cambio deliberado; no borres todo el proyecto para ocultar la causa.

### 6. Conecta el capítulo con RutaFlow

Aplica el aprendizaje de **Lógica de negocio compartida** a un incremento vertical de RutaFlow. Define qué componente produce el dato, qué contrato lo transporta, quién lo consume y cómo observarás un fallo. La entrega final incluye archivo o decisión, prueba, salida, error corregido y una limitación que todavía validarías en producción.
