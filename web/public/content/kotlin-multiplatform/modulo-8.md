...
Este recorrido parte de una carpeta vacía. Al finalizar tendrás **App SwiftUI consumiendo el módulo compartido KMP a través del framework generado, más tres ejercicios de evaluación.** No avances ejecutando comandos que no comprendes: primero identifica la entrada, la transformación y la evidencia que comprobará el resultado.
...
|---|---|---|
| 1. El framework generado para iOS | `shared/src/commonMain/kotlin/module-8/topic-1-el-framework-generado-para-ios.kt` | prueba + salida observable |
| 2. Mapeo de tipos Kotlin ↔ Swift | `shared/src/commonMain/kotlin/module-8/topic-2-mapeo-de-tipos-kotlin-swift.kt` | prueba + salida observable |
| 3. Coroutines desde Swift, y distribución del framework | `shared/src/commonMain/kotlin/module-8/topic-3-coroutines-desde-swift-y-distribucion-del-framework.kt` | prueba + salida observable |
...
**Resultado esperado:** el comando reconoce el proyecto y termina sin errores antes de introducir el cambio del capítulo. Después del incremento, la evidencia debe demostrar: **App SwiftUI consumiendo el módulo compartido KMP a través del framework generado, más tres ejercicios de evaluación.**

Si falla la línea base, no continúes. Localiza el primer mensaje que indique archivo, línea o dependencia; formula una causa y compruébala con un cambio pequeño.

### 5. Provoca un fallo y recupérate

Introduce un dato nulo o caso específico de plataforma; commonTest debe hacerlo visible. Guarda en `evidence/module-8/` el comando, la salida relevante, tu hipótesis y la corrección. Revierte únicamente el cambio deliberado; no borres todo el proyecto para ocultar la causa.

### 6. Conecta el capítulo con RutaFlow

Aplica el aprendizaje de **Interoperabilidad con iOS** a un incremento vertical de RutaFlow. Define qué componente produce el dato, qué contrato lo transporta, quién lo consume y cómo observarás un fallo. La entrega final incluye archivo o decisión, prueba, salida, error corregido y una limitación que todavía validarías en producción.
