...
Este recorrido parte de una carpeta vacía. Al finalizar tendrás **Capa de persistencia compartida con al menos una migración de esquema, más tres ejercicios de evaluación.** No avances ejecutando comandos que no comprendes: primero identifica la entrada, la transformación y la evidencia que comprobará el resultado.
...
|---|---|---|
| 1. Esquemas SQLDelight y queries tipadas | `shared/src/commonMain/kotlin/module-6/topic-1-esquemas-sqldelight-y-queries-tipadas.kt` | prueba + salida observable |
| 2. Drivers por plataforma | `shared/src/commonMain/kotlin/module-6/topic-2-drivers-por-plataforma.kt` | prueba + salida observable |
| 3. Migraciones de esquema | `shared/src/commonMain/kotlin/module-6/topic-3-migraciones-de-esquema.kt` | prueba + salida observable |
...
**Resultado esperado:** el comando reconoce el proyecto y termina sin errores antes de introducir el cambio del capítulo. Después del incremento, la evidencia debe demostrar: **Capa de persistencia compartida con al menos una migración de esquema, más tres ejercicios de evaluación.**

Si falla la línea base, no continúes. Localiza el primer mensaje que indique archivo, línea o dependencia; formula una causa y compruébala con un cambio pequeño.

### 5. Provoca un fallo y recupérate

Introduce un dato nulo o caso específico de plataforma; commonTest debe hacerlo visible. Guarda en `evidence/module-6/` el comando, la salida relevante, tu hipótesis y la corrección. Revierte únicamente el cambio deliberado; no borres todo el proyecto para ocultar la causa.

### 6. Conecta el capítulo con RutaFlow

Aplica el aprendizaje de **Persistencia compartida con SQLDelight** a un incremento vertical de RutaFlow. Define qué componente produce el dato, qué contrato lo transporta, quién lo consume y cómo observarás un fallo. La entrega final incluye archivo o decisión, prueba, salida, error corregido y una limitación que todavía validarías en producción.
