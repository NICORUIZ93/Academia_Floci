...
Este recorrido parte de una carpeta vacía. Al finalizar tendrás **Jerarquía de clases con al menos una interfaz y una clase abstracta, más tres ejercicios de evaluación.** No avances ejecutando comandos que no comprendes: primero identifica la entrada, la transformación y la evidencia que comprobará el resultado.
...
|---|---|---|
| 1. Clases, objetos, constructores y encapsulación | `src/main/java/academy/module-1/topic-1-clases-objetos-constructores-y-encapsulacion.java` | prueba + salida observable |
| 2. Herencia y sobreescritura | `src/main/java/academy/module-1/topic-2-herencia-y-sobreescritura.java` | prueba + salida observable |
| 3. Interfaces, clases abstractas y cuándo usar cada una | `src/main/java/academy/module-1/topic-3-interfaces-clases-abstractas-y-cuando-usar-cada-una.java` | prueba + salida observable |
| 4. Sobrecarga vs sobreescritura, y modificadores de acceso | `src/main/java/academy/module-1/topic-4-sobrecarga-vs-sobreescritura-y-modificadores-de-acceso.java` | prueba + salida observable |
...
**Resultado esperado:** el comando reconoce el proyecto y termina sin errores antes de introducir el cambio del capítulo. Después del incremento, la evidencia debe demostrar: **Jerarquía de clases con al menos una interfaz y una clase abstracta, más tres ejercicios de evaluación.**

Si falla la línea base, no continúes. Localiza el primer mensaje que indique archivo, línea o dependencia; formula una causa y compruébala con un cambio pequeño.

### 5. Provoca un fallo y recupérate

Viola una precondición o usa un valor frontera; la prueba debe expresar la regla incumplida. Guarda en `evidence/module-1/` el comando, la salida relevante, tu hipótesis y la corrección. Revierte únicamente el cambio deliberado; no borres todo el proyecto para ocultar la causa.

### 6. Conecta el capítulo con RutaFlow

Aplica el aprendizaje de **Programación orientada a objetos** a un incremento vertical de RutaFlow. Define qué componente produce el dato, qué contrato lo transporta, quién lo consume y cómo observarás un fallo. La entrega final incluye archivo o decisión, prueba, salida, error corregido y una limitación que todavía validarías en producción.
