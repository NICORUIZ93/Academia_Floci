...
Este recorrido parte de una carpeta vacía. Al finalizar tendrás **Aplicación Java con lógica concurrente, tests y build reproducible documentado, más tres ejercicios de evaluación de cierre.** No avances ejecutando comandos que no comprendes: primero identifica la entrada, la transformación y la evidencia que comprobará el resultado.
...
|---|---|---|
| 1. Arquitectura por capas del proyecto integrador | `src/main/java/academy/module-13/topic-1-arquitectura-por-capas-del-proyecto-integrador.java` | prueba + salida observable |
| 2. Integrando concurrencia, modelado y testing | `src/main/java/academy/module-13/topic-2-integrando-concurrencia-modelado-y-testing.java` | prueba + salida observable |
| 3. Build reproducible y cierre del track | `src/main/java/academy/module-13/topic-3-build-reproducible-y-cierre-del-track.java` | prueba + salida observable |
...
**Resultado esperado:** el comando reconoce el proyecto y termina sin errores antes de introducir el cambio del capítulo. Después del incremento, la evidencia debe demostrar: **Aplicación Java con lógica concurrente, tests y build reproducible documentado, más tres ejercicios de evaluación de cierre.**

Si falla la línea base, no continúes. Localiza el primer mensaje que indique archivo, línea o dependencia; formula una causa y compruébala con un cambio pequeño.

### 5. Provoca un fallo y recupérate

Viola una precondición o usa un valor frontera; la prueba debe expresar la regla incumplida. Guarda en `evidence/module-13/` el comando, la salida relevante, tu hipótesis y la corrección. Revierte únicamente el cambio deliberado; no borres todo el proyecto para ocultar la causa.

### 6. Conecta el capítulo con RutaFlow

Aplica el aprendizaje de **Proyecto integrador** a un incremento vertical de RutaFlow. Define qué componente produce el dato, qué contrato lo transporta, quién lo consume y cómo observarás un fallo. La entrega final incluye archivo o decisión, prueba, salida, error corregido y una limitación que todavía validarías en producción.
