...
Este recorrido parte de una carpeta vacía. Al finalizar tendrás **Pipeline de procesamiento de datos con Streams que reemplaza loops manuales, más tres ejercicios de evaluación.** No avances ejecutando comandos que no comprendes: primero identifica la entrada, la transformación y la evidencia que comprobará el resultado.
...
|---|---|---|
| 1. Stream API — map, filter, reduce, collect | `src/main/java/academy/module-4/topic-1-stream-api-map-filter-reduce-collect.java` | prueba + salida observable |
| 2. Optional — evitar null explícitamente | `src/main/java/academy/module-4/topic-2-optional-evitar-null-explicitamente.java` | prueba + salida observable |
| 3. Streams paralelos y referencias a métodos | `src/main/java/academy/module-4/topic-3-streams-paralelos-y-referencias-a-metodos.java` | prueba + salida observable |
...
**Resultado esperado:** el comando reconoce el proyecto y termina sin errores antes de introducir el cambio del capítulo. Después del incremento, la evidencia debe demostrar: **Pipeline de procesamiento de datos con Streams que reemplaza loops manuales, más tres ejercicios de evaluación.**

Si falla la línea base, no continúes. Localiza el primer mensaje que indique archivo, línea o dependencia; formula una causa y compruébala con un cambio pequeño.

### 5. Provoca un fallo y recupérate

Viola una precondición o usa un valor frontera; la prueba debe expresar la regla incumplida. Guarda en `evidence/module-4/` el comando, la salida relevante, tu hipótesis y la corrección. Revierte únicamente el cambio deliberado; no borres todo el proyecto para ocultar la causa.

### 6. Conecta el capítulo con RutaFlow

Aplica el aprendizaje de **Streams y programación funcional** a un incremento vertical de RutaFlow. Define qué componente produce el dato, qué contrato lo transporta, quién lo consume y cómo observarás un fallo. La entrega final incluye archivo o decisión, prueba, salida, error corregido y una limitación que todavía validarías en producción.
