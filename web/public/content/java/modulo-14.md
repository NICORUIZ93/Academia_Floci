...
|---|---|---|
| 1. Compartir memoria requiere orden y visibilidad | `src/main/java/academy/module-14/topic-1-compartir-memoria-requiere-orden-y-visibilidad.java` | prueba + salida observable |
| 2. La JVM optimiza y puede invalidar un cronómetro ingenuo | `src/main/java/academy/module-14/topic-2-la-jvm-optimiza-y-puede-invalidar-un-cronometro-ingenu.java` | prueba + salida observable |
| 3. Deserializar es permitir construcción y comportamiento | `src/main/java/academy/module-14/topic-3-deserializar-es-permitir-construccion-y-comportamiento.java` | prueba + salida observable |
| 4. El runtime es parte del artefacto y necesita ciclo de vida | `src/main/java/academy/module-14/topic-4-el-runtime-es-parte-del-artefacto-y-necesita-ciclo-de-.java` | prueba + salida observable |
...
Viola una precondición o usa un valor frontera; la prueba debe expresar la regla incumplida. Guarda en `evidence/module-14/` el comando, la salida relevante, tu hipótesis y la corrección. Revierte únicamente el cambio deliberado; no borres todo el proyecto para ocultar la causa.

### 6. Conecta el capítulo con RutaFlow

Aplica el aprendizaje de **Java en producción — memoria, benchmarks y runtime seguro** a un incremento vertical de RutaFlow. Define qué componente produce el dato, qué contrato lo transporta, quién lo consume y cómo observarás un fallo. La entrega final incluye archivo o decisión, prueba, salida, error corregido y una limitación que todavía validarías en producción.
