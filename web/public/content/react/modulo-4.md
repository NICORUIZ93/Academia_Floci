...
Este recorrido parte de una carpeta vacía. Al finalizar tendrás **Theme switcher (claro/oscuro) implementado con Context, sin prop drilling, más tres ejercicios de evaluación.** No avances ejecutando comandos que no comprendes: primero identifica la entrada, la transformación y la evidencia que comprobará el resultado.
...
|---|---|---|
| 1. createContext y useContext | `src/features/module-4/topic-1-createcontext-y-usecontext.tsx` | prueba + salida observable |
| 2. Cuándo Context es suficiente y cuándo no | `src/features/module-4/topic-2-cuando-context-es-suficiente-y-cuando-no.tsx` | prueba + salida observable |
| 3. Componentes compuestos, render props y hooks personalizados | `src/features/module-4/topic-3-componentes-compuestos-render-props-y-hooks-personaliz.tsx` | prueba + salida observable |
...
**Resultado esperado:** el comando reconoce el proyecto y termina sin errores antes de introducir el cambio del capítulo. Después del incremento, la evidencia debe demostrar: **Theme switcher (claro/oscuro) implementado con Context, sin prop drilling, más tres ejercicios de evaluación.**

Si falla la línea base, no continúes. Localiza el primer mensaje que indique archivo, línea o dependencia; formula una causa y compruébala con un cambio pequeño.

### 5. Provoca un fallo y recupérate

Cambia una prop o respuesta a un caso vacío o erróneo; observa el estado visual y corrige desde la primera causa. Guarda en `evidence/module-4/` el comando, la salida relevante, tu hipótesis y la corrección. Revierte únicamente el cambio deliberado; no borres todo el proyecto para ocultar la causa.

### 6. Conecta el capítulo con RutaFlow

Aplica el aprendizaje de **Context API y composición** a un incremento vertical de RutaFlow. Define qué componente produce el dato, qué contrato lo transporta, quién lo consume y cómo observarás un fallo. La entrega final incluye archivo o decisión, prueba, salida, error corregido y una limitación que todavía validarías en producción.
