...
|---|---|---|
| 1. Configuración básica de Hilt | `app/src/main/java/academy/module-7/topic-1-configuracion-basica-de-hilt.kt` | prueba + salida observable |
| 2. @Provides y @Binds | `app/src/main/java/academy/module-7/topic-2-provides-y-binds.kt` | prueba + salida observable |
| 3. Scopes y testing con Hilt | `app/src/main/java/academy/module-7/topic-3-scopes-y-testing-con-hilt.kt` | prueba + salida observable |
...
**Resultado esperado:** el comando reconoce el proyecto y termina sin errores antes de introducir el cambio del capítulo. Después del incremento, la evidencia debe demostrar: **App con todas sus dependencias (repos, servicios) inyectadas vía Hilt, más tres ejercicios de evaluación.**

Si falla la línea base, no continúes. Localiza el primer mensaje que indique archivo, línea o dependencia; formula una causa y compruébala con un cambio pequeño.

### 5. Provoca un fallo y recupérate

Simula permiso denegado, proceso recreado o dato ausente; verifica que la pantalla conserve un estado comprensible. Guarda en `evidence/module-7/` el comando, la salida relevante, tu hipótesis y la corrección. Revierte únicamente el cambio deliberado; no borres todo el proyecto para ocultar la causa.

### 6. Conecta el capítulo con RutaFlow

Aplica el aprendizaje de **Inyección de dependencias con Hilt** a un incremento vertical de RutaFlow. Define qué componente produce el dato, qué contrato lo transporta, quién lo consume y cómo observarás un fallo. La entrega final incluye archivo o decisión, prueba, salida, error corregido y una limitación que todavía validarías en producción.
