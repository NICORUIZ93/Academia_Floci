...
Este recorrido parte de una carpeta vacía. Al finalizar tendrás **App Bundle firmado, listo para subir a un track de pruebas internas en Play Console, más tres ejercicios de evaluación.** No avances ejecutando comandos que no comprendes: primero identifica la entrada, la transformación y la evidencia que comprobará el resultado.
...
|---|---|---|
| 1. Firma de la app | `app/src/main/java/academy/module-11/topic-1-firma-de-la-app.kt` | prueba + salida observable |
| 2. App Bundle vs APK | `app/src/main/java/academy/module-11/topic-2-app-bundle-vs-apk.kt` | prueba + salida observable |
| 3. Versionado, tracks y políticas | `app/src/main/java/academy/module-11/topic-3-versionado-tracks-y-politicas.kt` | prueba + salida observable |
...
**Resultado esperado:** el comando reconoce el proyecto y termina sin errores antes de introducir el cambio del capítulo. Después del incremento, la evidencia debe demostrar: **App Bundle firmado, listo para subir a un track de pruebas internas en Play Console, más tres ejercicios de evaluación.**

Si falla la línea base, no continúes. Localiza el primer mensaje que indique archivo, línea o dependencia; formula una causa y compruébala con un cambio pequeño.

### 5. Provoca un fallo y recupérate

Simula permiso denegado, proceso recreado o dato ausente; verifica que la pantalla conserve un estado comprensible. Guarda en `evidence/module-11/` el comando, la salida relevante, tu hipótesis y la corrección. Revierte únicamente el cambio deliberado; no borres todo el proyecto para ocultar la causa.

### 6. Conecta el capítulo con RutaFlow

Aplica el aprendizaje de **Publicación en Google Play** a un incremento vertical de RutaFlow. Define qué componente produce el dato, qué contrato lo transporta, quién lo consume y cómo observarás un fallo. La entrega final incluye archivo o decisión, prueba, salida, error corregido y una limitación que todavía validarías en producción.
