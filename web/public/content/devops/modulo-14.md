...
|---|---|---|
| 1. Confiabilidad es una expectativa cuantificada | `infra/module-14/topic-1-confiabilidad-es-una-expectativa-cuantificada.yaml` | prueba + salida observable |
| 2. Una alerta debe conducir a una acción | `infra/module-14/topic-2-una-alerta-debe-conducir-a-una-accion.yaml` | prueba + salida observable |
| 3. Construir una imagen no demuestra de dónde proviene | `infra/module-14/topic-3-construir-una-imagen-no-demuestra-de-donde-proviene.yaml` | prueba + salida observable |
| 4. Una plataforma interna es un producto con límites | `infra/module-14/topic-4-una-plataforma-interna-es-un-producto-con-limites.yaml` | prueba + salida observable |
...
Rompe una referencia, variable o healthcheck y localiza la causa con la validación o los logs. Guarda en `evidence/module-14/` el comando, la salida relevante, tu hipótesis y la corrección. Revierte únicamente el cambio deliberado; no borres todo el proyecto para ocultar la causa.

### 6. Conecta el capítulo con RutaFlow

Aplica el aprendizaje de **SRE y plataforma — confiabilidad, incidentes y supply chain** a un incremento vertical de RutaFlow. Define qué componente produce el dato, qué contrato lo transporta, quién lo consume y cómo observarás un fallo. La entrega final incluye archivo o decisión, prueba, salida, error corregido y una limitación que todavía validarías en producción.
