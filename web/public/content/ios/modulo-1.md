...
Este recorrido parte de una carpeta vacía. Al finalizar tendrás **Pantalla SwiftUI compuesta a partir de al menos 3 vistas reutilizables propias, más tres ejercicios de evaluación.** No avances ejecutando comandos que no comprendes: primero identifica la entrada, la transformación y la evidencia que comprobará el resultado.
...
|---|---|---|
| 1. El protocolo View y composición | `Features/module-1/topic-1-el-protocolo-view-y-composicion.swift` | prueba + salida observable |
| 2. Orden de modificadores y layout con stacks | `Features/module-1/topic-2-orden-de-modificadores-y-layout-con-stacks.swift` | prueba + salida observable |
| 3. Previews, LazyVGrid/ScrollView y property wrappers | `Features/module-1/topic-3-previews-lazyvgrid-scrollview-y-property-wrappers.swift` | prueba + salida observable |
...
**Resultado esperado:** el comando reconoce el proyecto y termina sin errores antes de introducir el cambio del capítulo. Después del incremento, la evidencia debe demostrar: **Pantalla SwiftUI compuesta a partir de al menos 3 vistas reutilizables propias, más tres ejercicios de evaluación.**

Si falla la línea base, no continúes. Localiza el primer mensaje que indique archivo, línea o dependencia; formula una causa y compruébala con un cambio pequeño.

### 5. Provoca un fallo y recupérate

Simula permiso denegado, respuesta vacía o tarea cancelada; verifica estado y mensaje. SwiftUI requiere macOS. Guarda en `evidence/module-1/` el comando, la salida relevante, tu hipótesis y la corrección. Revierte únicamente el cambio deliberado; no borres todo el proyecto para ocultar la causa.

### 6. Conecta el capítulo con RutaFlow

Aplica el aprendizaje de **SwiftUI: vistas y layout declarativo** a un incremento vertical de RutaFlow. Define qué componente produce el dato, qué contrato lo transporta, quién lo consume y cómo observarás un fallo. La entrega final incluye archivo o decisión, prueba, salida, error corregido y una limitación que todavía validarías en producción.
