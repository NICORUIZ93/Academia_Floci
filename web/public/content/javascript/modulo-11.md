...
Este recorrido parte de una carpeta vacía. Al finalizar tendrás **Una migración de un módulo JavaScript existente a TypeScript estricto sin usar `any`, más tres ejercicios de evaluación.** No avances ejecutando comandos que no comprendes: primero identifica la entrada, la transformación y la evidencia que comprobará el resultado.
...
|---|---|---|
| 1. Tipos básicos, interfaces y type aliases | `src/module-11/topic-1-tipos-basicos-interfaces-y-type-aliases.ts` | prueba + salida observable |
| 2. Generics | `src/module-11/topic-2-generics.ts` | prueba + salida observable |
| 3. Narrowing y union types | `src/module-11/topic-3-narrowing-y-union-types.ts` | prueba + salida observable |
| 4. tsconfig esencial y modo strict | `src/module-11/topic-4-tsconfig-esencial-y-modo-strict.ts` | prueba + salida observable |
...
**Resultado esperado:** el comando reconoce el proyecto y termina sin errores antes de introducir el cambio del capítulo. Después del incremento, la evidencia debe demostrar: **Una migración de un módulo JavaScript existente a TypeScript estricto sin usar `any`, más tres ejercicios de evaluación.**

Si falla la línea base, no continúes. Localiza el primer mensaje que indique archivo, línea o dependencia; formula una causa y compruébala con un cambio pequeño.

### 5. Provoca un fallo y recupérate

Prueba un valor límite, un tipo inesperado o una operación fuera de orden; compara la salida con tu predicción. Guarda en `evidence/module-11/` el comando, la salida relevante, tu hipótesis y la corrección. Revierte únicamente el cambio deliberado; no borres todo el proyecto para ocultar la causa.

### 6. Conecta el capítulo con RutaFlow

Aplica el aprendizaje de **TypeScript esencial para devs de JavaScript** a un incremento vertical de RutaFlow. Define qué componente produce el dato, qué contrato lo transporta, quién lo consume y cómo observarás un fallo. La entrega final incluye archivo o decisión, prueba, salida, error corregido y una limitación que todavía validarías en producción.
