...
|---|---|---|
| 1. Datos no confiables y seguridad en el navegador | `src/module-13/topic-1-datos-no-confiables-y-seguridad-en-el-navegador.ts` | prueba + salida observable |
| 2. Memoria administrada no significa memoria infinita | `src/module-13/topic-2-memoria-administrada-no-significa-memoria-infinita.ts` | prueba + salida observable |
| 3. Errores útiles sin convertir usuarios en sensores involuntarios | `src/module-13/topic-3-errores-utiles-sin-convertir-usuarios-en-sensores-invo.ts` | prueba + salida observable |
| 4. Compatibilidad, idioma y tiempo son requisitos de datos | `src/module-13/topic-4-compatibilidad-idioma-y-tiempo-son-requisitos-de-datos.ts` | prueba + salida observable |
...
Prueba un valor límite, un tipo inesperado o una operación fuera de orden; compara la salida con tu predicción. Guarda en `evidence/module-13/` el comando, la salida relevante, tu hipótesis y la corrección. Revierte únicamente el cambio deliberado; no borres todo el proyecto para ocultar la causa.

### 6. Conecta el capítulo con RutaFlow

Aplica el aprendizaje de **JavaScript en producción — seguridad, memoria y compatibilidad** a un incremento vertical de RutaFlow. Define qué componente produce el dato, qué contrato lo transporta, quién lo consume y cómo observarás un fallo. La entrega final incluye archivo o decisión, prueba, salida, error corregido y una limitación que todavía validarías en producción.
