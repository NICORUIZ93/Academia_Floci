...
Este recorrido parte de una carpeta vacía. Al finalizar tendrás **Una jerarquía de clases con herencia y encapsulación real (campos privados), más tres ejercicios de evaluación sobre prototipos, herencia y encapsulación.** No avances ejecutando comandos que no comprendes: primero identifica la entrada, la transformación y la evidencia que comprobará el resultado.
...
|---|---|---|
| 1. Prototype chain y Object.create | `src/module-3/topic-1-prototype-chain-y-object-create.ts` | prueba + salida observable |
| 2. class, extends y super | `src/module-3/topic-2-class-extends-y-super.ts` | prueba + salida observable |
| 3. Getters, setters y propiedades computadas | `src/module-3/topic-3-getters-setters-y-propiedades-computadas.ts` | prueba + salida observable |
| 4. Encapsulación con campos privados (#campo) | `src/module-3/topic-4-encapsulacion-con-campos-privados-campo.ts` | prueba + salida observable |
...
Prueba un valor límite, un tipo inesperado o una operación fuera de orden; compara la salida con tu predicción. Guarda en `evidence/module-3/` el comando, la salida relevante, tu hipótesis y la corrección. Revierte únicamente el cambio deliberado; no borres todo el proyecto para ocultar la causa.

### 6. Conecta el capítulo con RutaFlow

Aplica el aprendizaje de **Objetos, prototipos y clases** a un incremento vertical de RutaFlow. Define qué componente produce el dato, qué contrato lo transporta, quién lo consume y cómo observarás un fallo. La entrega final incluye archivo o decisión, prueba, salida, error corregido y una limitación que todavía validarías en producción.
