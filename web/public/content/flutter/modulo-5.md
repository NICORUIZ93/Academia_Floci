...
|---|---|---|
| 1. http vs dio | `lib/features/module-5/topic-1-http-vs-dio.dart` | prueba + salida observable |
| 2. json_serializable | `lib/features/module-5/topic-2-json-serializable.dart` | prueba + salida observable |
| 3. Interceptores y estados explícitos | `lib/features/module-5/topic-3-interceptores-y-estados-explicitos.dart` | prueba + salida observable |
...
Simula pérdida de red, permiso denegado o widget desmontado; comprueba la recuperación sin errores ocultos. Guarda en `evidence/module-5/` el comando, la salida relevante, tu hipótesis y la corrección. Revierte únicamente el cambio deliberado; no borres todo el proyecto para ocultar la causa.

### 6. Conecta el capítulo con RutaFlow

Aplica el aprendizaje de **Networking** a un incremento vertical de RutaFlow. Define qué componente produce el dato, qué contrato lo transporta, quién lo consume y cómo observarás un fallo. La entrega final incluye archivo o decisión, prueba, salida, error corregido y una limitación que todavía validarías en producción.
