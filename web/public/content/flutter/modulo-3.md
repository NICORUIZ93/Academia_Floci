...
Este recorrido parte de una carpeta vacía. Al finalizar tendrás **App con rutas declarativas (go_router), una ruta protegida y deep linking, más tres ejercicios de evaluación.** No avances ejecutando comandos que no comprendes: primero identifica la entrada, la transformación y la evidencia que comprobará el resultado.
...
|---|---|---|
| 1. go_router: navegación como función de la URL | `lib/features/module-3/topic-1-go-router-navegacion-como-funcion-de-la-url.dart` | prueba + salida observable |
| 2. Guards y deep linking | `lib/features/module-3/topic-2-guards-y-deep-linking.dart` | prueba + salida observable |
| 3. Transiciones personalizadas | `lib/features/module-3/topic-3-transiciones-personalizadas.dart` | prueba + salida observable |
...
**Resultado esperado:** el comando reconoce el proyecto y termina sin errores antes de introducir el cambio del capítulo. Después del incremento, la evidencia debe demostrar: **App con rutas declarativas (go_router), una ruta protegida y deep linking, más tres ejercicios de evaluación.**

Si falla la línea base, no continúes. Localiza el primer mensaje que indique archivo, línea o dependencia; formula una causa y compruébala con un cambio pequeño.

### 5. Provoca un fallo y recupérate

Simula pérdida de red, permiso denegado o widget desmontado; comprueba la recuperación sin errores ocultos. Guarda en `evidence/module-3/` el comando, la salida relevante, tu hipótesis y la corrección. Revierte únicamente el cambio deliberado; no borres todo el proyecto para ocultar la causa.

### 6. Conecta el capítulo con RutaFlow

Aplica el aprendizaje de **Navegación y rutas** a un incremento vertical de RutaFlow. Define qué componente produce el dato, qué contrato lo transporta, quién lo consume y cómo observarás un fallo. La entrega final incluye archivo o decisión, prueba, salida, error corregido y una limitación que todavía validarías en producción.
