...
Este recorrido parte de una carpeta vacía. Al finalizar tendrás **App con theming consistente, dark mode y accesibilidad auditada, más tres ejercicios de evaluación.** No avances ejecutando comandos que no comprendes: primero identifica la entrada, la transformación y la evidencia que comprobará el resultado.
...
|---|---|---|
| 1. ThemeData con Material 3 | `lib/features/module-10/topic-1-themedata-con-material-3.dart` | prueba + salida observable |
| 2. Adaptación Material vs Cupertino | `lib/features/module-10/topic-2-adaptacion-material-vs-cupertino.dart` | prueba + salida observable |
| 3. Accesibilidad con Semantics y dark mode | `lib/features/module-10/topic-3-accesibilidad-con-semantics-y-dark-mode.dart` | prueba + salida observable |
...
**Resultado esperado:** el comando reconoce el proyecto y termina sin errores antes de introducir el cambio del capítulo. Después del incremento, la evidencia debe demostrar: **App con theming consistente, dark mode y accesibilidad auditada, más tres ejercicios de evaluación.**

Si falla la línea base, no continúes. Localiza el primer mensaje que indique archivo, línea o dependencia; formula una causa y compruébala con un cambio pequeño.

### 5. Provoca un fallo y recupérate

Simula pérdida de red, permiso denegado o widget desmontado; comprueba la recuperación sin errores ocultos. Guarda en `evidence/module-10/` el comando, la salida relevante, tu hipótesis y la corrección. Revierte únicamente el cambio deliberado; no borres todo el proyecto para ocultar la causa.

### 6. Conecta el capítulo con RutaFlow

Aplica el aprendizaje de **Theming, accesibilidad y Material/Cupertino** a un incremento vertical de RutaFlow. Define qué componente produce el dato, qué contrato lo transporta, quién lo consume y cómo observarás un fallo. La entrega final incluye archivo o decisión, prueba, salida, error corregido y una limitación que todavía validarías en producción.
