...
Este recorrido parte de una carpeta vacía. Al finalizar tendrás **Platform channel propio y flujo de evidencia fotográfica verificable, más cuatro ejercicios de evaluación.** No avances ejecutando comandos que no comprendes: primero identifica la entrada, la transformación y la evidencia que comprobará el resultado.
...
|---|---|---|
| 1. MethodChannel | `lib/features/module-7/topic-1-methodchannel.dart` | prueba + salida observable |
| 2. Plugins federados | `lib/features/module-7/topic-2-plugins-federados.dart` | prueba + salida observable |
| 3. Permisos de plataforma y cuándo escribir un platform channel propio | `lib/features/module-7/topic-3-permisos-de-plataforma-y-cuando-escribir-un-platform-c.dart` | prueba + salida observable |
| 4. Cámara, galería y carga multipart de una evidencia | `lib/features/module-7/topic-4-camara-galeria-y-carga-multipart-de-una-evidencia.dart` | prueba + salida observable |
...
**Resultado esperado:** el comando reconoce el proyecto y termina sin errores antes de introducir el cambio del capítulo. Después del incremento, la evidencia debe demostrar: **Platform channel propio y flujo de evidencia fotográfica verificable, más cuatro ejercicios de evaluación.**

Si falla la línea base, no continúes. Localiza el primer mensaje que indique archivo, línea o dependencia; formula una causa y compruébala con un cambio pequeño.

### 5. Provoca un fallo y recupérate

Simula pérdida de red, permiso denegado o widget desmontado; comprueba la recuperación sin errores ocultos. Guarda en `evidence/module-7/` el comando, la salida relevante, tu hipótesis y la corrección. Revierte únicamente el cambio deliberado; no borres todo el proyecto para ocultar la causa.

### 6. Conecta el capítulo con RutaFlow

Aplica el aprendizaje de **Integración con plataformas nativas** a un incremento vertical de RutaFlow. Define qué componente produce el dato, qué contrato lo transporta, quién lo consume y cómo observarás un fallo. La entrega final incluye archivo o decisión, prueba, salida, error corregido y una limitación que todavía validarías en producción.
