...
Este recorrido parte de una carpeta vacía. Al finalizar tendrás **Feature completa implementada con Riverpod (o Bloc), formulario validado y cuatro ejercicios de evaluación.** No avances ejecutando comandos que no comprendes: primero identifica la entrada, la transformación y la evidencia que comprobará el resultado.
...
|---|---|---|
| 1. setState y sus límites | `lib/features/module-4/topic-1-setstate-y-sus-limites.dart` | prueba + salida observable |
| 2. Riverpod | `lib/features/module-4/topic-2-riverpod.dart` | prueba + salida observable |
| 3. Bloc/Cubit y otras alternativas | `lib/features/module-4/topic-3-bloc-cubit-y-otras-alternativas.dart` | prueba + salida observable |
| 4. Formularios profesionales con Formz y Riverpod | `lib/features/module-4/topic-4-formularios-profesionales-con-formz-y-riverpod.dart` | prueba + salida observable |
...
**Resultado esperado:** el comando reconoce el proyecto y termina sin errores antes de introducir el cambio del capítulo. Después del incremento, la evidencia debe demostrar: **Feature completa implementada con Riverpod (o Bloc), formulario validado y cuatro ejercicios de evaluación.**

Si falla la línea base, no continúes. Localiza el primer mensaje que indique archivo, línea o dependencia; formula una causa y compruébala con un cambio pequeño.

### 5. Provoca un fallo y recupérate

Simula pérdida de red, permiso denegado o widget desmontado; comprueba la recuperación sin errores ocultos. Guarda en `evidence/module-4/` el comando, la salida relevante, tu hipótesis y la corrección. Revierte únicamente el cambio deliberado; no borres todo el proyecto para ocultar la causa.
