...
|---|---|---|
| 1. La red convierte el resultado en una incertidumbre | `src/module-10/topic-1-la-red-convierte-el-resultado-en-una-incertidumbre.py` | prueba + salida observable |
| 2. Replicación, consistencia y decisiones explícitas | `src/module-10/topic-2-replicacion-consistencia-y-decisiones-explicitas.py` | prueba + salida observable |
| 3. Mensajes que se procesan con efectos exactamente una vez | `src/module-10/topic-3-mensajes-que-se-procesan-con-efectos-exactamente-una-v.py` | prueba + salida observable |
| 4. Resiliencia y observabilidad orientadas a objetivos | `src/module-10/topic-4-resiliencia-y-observabilidad-orientadas-a-objetivos.py` | prueba + salida observable |
...
Usa una entrada inválida o elimina una precondición y conserva el mensaje que explica la causa. Guarda en `evidence/module-10/` el comando, la salida relevante, tu hipótesis y la corrección. Revierte únicamente el cambio deliberado; no borres todo el proyecto para ocultar la causa.

### 6. Conecta el capítulo con RutaFlow

Aplica el aprendizaje de **Módulo 10** a un incremento vertical de RutaFlow. Define qué componente produce el dato, qué contrato lo transporta, quién lo consume y cómo observarás un fallo. La entrega final incluye archivo o decisión, prueba, salida, error corregido y una limitación que todavía validarías en producción.
