...
|---|---|---|
| 1. Depurar con evidencia, no con cambios aleatorios | `src/module-5/topic-1-depurar-con-evidencia-no-con-cambios-aleatorios.py` | prueba + salida observable |
| 2. Pruebas con propósito y niveles adecuados | `src/module-5/topic-2-pruebas-con-proposito-y-niveles-adecuados.py` | prueba + salida observable |
| 3. Git como historial de decisiones y colaboración | `src/module-5/topic-3-git-como-historial-de-decisiones-y-colaboracion.py` | prueba + salida observable |
| 4. Calidad estática, revisión e integración continua | `src/module-5/topic-4-calidad-estatica-revision-e-integracion-continua.py` | prueba + salida observable |
...
Usa una entrada inválida o elimina una precondición y conserva el mensaje que explica la causa. Guarda en `evidence/module-5/` el comando, la salida relevante, tu hipótesis y la corrección. Revierte únicamente el cambio deliberado; no borres todo el proyecto para ocultar la causa.

### 6. Conecta el capítulo con RutaFlow

Aplica el aprendizaje de **Testing, depuración, Git y CI** a un incremento vertical de RutaFlow. Define qué componente produce el dato, qué contrato lo transporta, quién lo consume y cómo observarás un fallo. La entrega final incluye archivo o decisión, prueba, salida, error corregido y una limitación que todavía validarías en producción.
