...
|---|---|---|
| 1. Lógica para especificar antes de programar | `src/module-9/topic-1-logica-para-especificar-antes-de-programar.py` | prueba + salida observable |
| 2. Conjuntos, relaciones, funciones e inducción | `src/module-9/topic-2-conjuntos-relaciones-funciones-e-induccion.py` | prueba + salida observable |
| 3. Conteo, grafos y estructuras conectadas | `src/module-9/topic-3-conteo-grafos-y-estructuras-conectadas.py` | prueba + salida observable |
| 4. Probabilidad y evidencia para decisiones técnicas | `src/module-9/topic-4-probabilidad-y-evidencia-para-decisiones-tecnicas.py` | prueba + salida observable |
...
Usa una entrada inválida o elimina una precondición y conserva el mensaje que explica la causa. Guarda en `evidence/module-9/` el comando, la salida relevante, tu hipótesis y la corrección. Revierte únicamente el cambio deliberado; no borres todo el proyecto para ocultar la causa.

### 6. Conecta el capítulo con RutaFlow

Aplica el aprendizaje de **Módulo 9** a un incremento vertical de RutaFlow. Define qué componente produce el dato, qué contrato lo transporta, quién lo consume y cómo observarás un fallo. La entrega final incluye archivo o decisión, prueba, salida, error corregido y una limitación que todavía validarías en producción.
