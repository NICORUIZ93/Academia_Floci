...
|---|---|---|
| 1. Del problema al algoritmo y a los casos de prueba | `src/module-1/topic-1-del-problema-al-algoritmo-y-a-los-casos-de-prueba.py` | prueba + salida observable |
| 2. Variables, tipos, expresiones y cambios de estado | `src/module-1/topic-2-variables-tipos-expresiones-y-cambios-de-estado.py` | prueba + salida observable |
| 3. Decisiones, repeticiones y trazado de ejecución | `src/module-1/topic-3-decisiones-repeticiones-y-trazado-de-ejecucion.py` | prueba + salida observable |
| 4. Funciones y descomposición de problemas | `src/module-1/topic-4-funciones-y-descomposicion-de-problemas.py` | prueba + salida observable |
...
Usa una entrada inválida o elimina una precondición y conserva el mensaje que explica la causa. Guarda en `evidence/module-1/` el comando, la salida relevante, tu hipótesis y la corrección. Revierte únicamente el cambio deliberado; no borres todo el proyecto para ocultar la causa.

### 6. Conecta el capítulo con RutaFlow

Aplica el aprendizaje de **Pensamiento computacional y programación** a un incremento vertical de RutaFlow. Define qué componente produce el dato, qué contrato lo transporta, quién lo consume y cómo observarás un fallo. La entrega final incluye archivo o decisión, prueba, salida, error corregido y una limitación que todavía validarías en producción.
