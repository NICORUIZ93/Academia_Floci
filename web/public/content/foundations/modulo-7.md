...
|---|---|---|
| 1. Requisitos, stakeholders y criterios verificables | `src/module-7/topic-1-requisitos-stakeholders-y-criterios-verificables.py` | prueba + salida observable |
| 2. Arquitectura guiada por atributos de calidad | `src/module-7/topic-2-arquitectura-guiada-por-atributos-de-calidad.py` | prueba + salida observable |
| 3. Diseño modular, principios, patrones y refactoring | `src/module-7/topic-3-diseno-modular-principios-patrones-y-refactoring.py` | prueba + salida observable |
| 4. Decisiones, documentación, deuda y evolución | `src/module-7/topic-4-decisiones-documentacion-deuda-y-evolucion.py` | prueba + salida observable |
...
Usa una entrada inválida o elimina una precondición y conserva el mensaje que explica la causa. Guarda en `evidence/module-7/` el comando, la salida relevante, tu hipótesis y la corrección. Revierte únicamente el cambio deliberado; no borres todo el proyecto para ocultar la causa.

### 6. Conecta el capítulo con RutaFlow

Aplica el aprendizaje de **Requisitos, diseño, arquitectura y mantenimiento** a un incremento vertical de RutaFlow. Define qué componente produce el dato, qué contrato lo transporta, quién lo consume y cómo observarás un fallo. La entrega final incluye archivo o decisión, prueba, salida, error corregido y una limitación que todavía validarías en producción.
